...
@WebServlet(name = "boardGetPostController", urlPatterns = "/board/post")
public class BoardGetPostController extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String viewName = boardService.getPost(paramMap, model);
